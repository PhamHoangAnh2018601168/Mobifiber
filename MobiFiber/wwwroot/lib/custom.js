...
Date.prototype.formatDateTime = function () {
    return this.formatDate('dd/MM/yyyy HH:mm:ss T');
}
/**************** Extend String **************************/
...
String.prototype.toVND = function () {
    var DecimalPlaces = appSetting.config.currency.DecimalPlaces;
    var DecimalSeparator = appSetting.config.currency.DecimalSeparator;
    var ThousandsSeparator = appSetting.config.currency.ThousandsSeparator;
    return $.number(this || 0, DecimalPlaces, DecimalSeparator, ThousandsSeparator) + ' VNĐ';
}
...
String.prototype.toDate = function (format) {
    format = format || appSetting.config.date.moment;
